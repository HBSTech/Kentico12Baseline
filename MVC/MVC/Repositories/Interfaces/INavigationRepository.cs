...
namespace Generic.Repositories.Interfaces
{
    public interface INavigationRepository: IRepository
    {
        ...
        /// <summary>
        /// Retrieves the HTML for the given Mega Menu
        /// </summary>
        /// <param name="LinkPageIdentifier">The NodeAliasPath of the page</param>
        /// <returns>The HTML content of the mega menu</returns>
        string GetNavMegaMenuContent(string LinkPageIdentifier);
