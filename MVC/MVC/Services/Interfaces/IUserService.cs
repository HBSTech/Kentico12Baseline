...
namespace Generic.Services.Interfaces
{
    public interface IUserService : IService
    {
        ...
        IUserInfo BasicUserToIUser(BasicUser User);
        ...
        IUserInfo CreateUser(IUserInfo User, string Password, bool Enabled = false);
        ...
        IdentityResult ResetPasswordFromToken(int UserID, string Token, string NewPassword);
