...
public partial class Startup
{
    ...
    public void Configuration(IAppBuilder app)
    {
        ...
        app.UseCookieAuthentication(new CookieAuthenticationOptions
        {
            ...
            LoginPath = new PathString(urlHelper.Action(CoreServices.AppSettings["LoginView"], CoreServices.AppSettings["LoginController"])),
            Provider = new CookieAuthenticationProvider
            {
                // Sets the return URL for the sign-in page redirect (fill in the name of your sign-in action and controller)
                OnApplyRedirect = context => context.Response.Redirect(urlHelper.Action(CoreServices.AppSettings["LoginView"], CoreServices.AppSettings["LoginController"])
