    ...
    public class EnvironmentHelper
    {
        ...
        public static bool PageBuilderEnabled
        {
            get
            {
                try
                {
                    return HttpContext.Current.Kentico().PageBuilder().PageIdentifier > 0;
                }
                catch (InvalidOperationException)
                {
                    // This occurs only on the Owin Authentication calls due to the Dynamic route handler
        ...
        /// <summary>
        /// Returns true if Edit mode is enabled and the page context is set.
        /// </summary>
        ...
        {
            string Username = (User != null && User.Identity != null ? DataHelper.GetNotEmpty(User.Identity.Name, "public") : "public");
